...
const products = {
  Smoother: {
    ...
    name: "Smoother",
    description:
      "Unleash Your Gaming Potential Without Breaking the Bank! <br>Introducing our latest budget-friendly gaming PC, designed for gamers who demand performance without the hefty price tag. This low-end gaming powerhouse is perfect for diving into the world of gaming, whether you're exploring vast open worlds, competing in intense multiplayer battles, or embarking on epic quests.",
    price: 649.99,
    components: {
  ...
  Beast: {
    ...
    name: "Beast",
    description:
      "Elevate Your Gaming Experience with Our Next-Level Gaming PC! <br>Step up your game with our new gaming PC, crafted for gamers who seek a perfect balance of performance, quality, and affordability. Whether you're aiming for high scores, exploring new worlds, or streaming your gameplay, this gaming rig is built to deliver an exceptional experience - Take the next step in your gaming journey and secure your system now!",
    price: 999.99,
    components: {
  ...
  Terminator: {
    ...
    name: "Terminator",
    description:
      "Enhance Your Gaming Experience with Our Advanced Gaming PC! <br>Take your gaming to new heights with our advanced gaming PC, designed for enthusiasts who seek impressive performance and cutting-edge technology. Whether you're conquering the latest AAA titles, streaming your gameplay, or creating content, this rig delivers the power and precision needed to excel.",
    price: 1599.99,
    components: {
  ...
  return (
    <main className="main-dream-pc">
      <div className="product-info section">
        <h1 id="product-name" className="product-part">
          {product.name}
        </h1>
        <p
          id="product-description"
          className="product-part"
          dangerouslySetInnerHTML={{ __html: product.description }}
        ></p>
        <p id="product-price" className="product-part">
      ...
      <div className="carousel-container">
        ...
        <div className="carousel-dots-container">
          ...
          <p className="component-disclaimer">
            * Your product may look slightly different depending on component
            availability.
          </p>
